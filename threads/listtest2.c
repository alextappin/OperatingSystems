...
//        pthread_mutex_lock(&mutexList);
        ...
        //list_tt *caster = (list_tt *) ptr;
        //if (caster->next != NULL)
            //pthread_mutex_unlock(&(caster->mutex));
        while (ptr != NULL)
        {
            prev = ptr;
            ptr = List_Next(prev);
        ...
        //make sure ptr->next->next != null
        //if (caster->next->next != NULL)
        //{
            //pthread_mutex_unlock(&(caster->next->mutex));
            //pthread_mutex_unlock(&(caster->next->next->mutex));
        //}
        //unlock on ptr->next and ptr->next->next
